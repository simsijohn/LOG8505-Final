 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.sierra.impl.ComponentImpl#getPerforms <em>Performs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentImpl extends ContainableElementImpl implements Component {
	...
	protected EClass eStaticClass() {
		return SierraPackage.Literals.COMPONENT;
	}
	...
	public EList<Function> getPerforms() {
		if (performs == null) {
			performs = new EObjectWithInverseResolvingEList.ManyInverse<Function>(Function.class, this,
					SierraPackage.COMPONENT__PERFORMS, SierraPackage.FUNCTION__IS_PERFORMED_BY);
		}
		return performs;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SierraPackage.COMPONENT__PERFORMS:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == PerformingElement.class) {
			...
			case SierraPackage.PERFORMING_ELEMENT__PERFORMS:
				return SierraPackage.COMPONENT__PERFORMS;
			default:
				return -1;
			}
		}
